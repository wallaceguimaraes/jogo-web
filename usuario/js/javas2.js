...
vel2=25;
	...
	segundos = segundos;
	  ...
	  //var jo1 =sessionStorage.getItem('Nomejogador1');
	  //var jo2 =sessionStorage.setItem('Nomejogador2');
//document.getElementById('inputJogador1').value=jo1;
//document.getElementById('inputJogador2').value=jo2;
	...
	//posicaoAleatoria();//se chamar mais de uma vez é preciso mudar o tempo
	//verificaMusica();
...
/*
function exibe2(){// função que exibe os pratos
